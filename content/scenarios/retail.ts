      ...
      options: [
        {
          ...
          deltas: { inventory_balance: 4, margin: -1 },
        ...
        },
        {
          ...
          deltas: { margin: 3, customer_satisfaction: -4 },
          evidence_he: "העלה את מחיר המוצר באופן זמני בסניפים שבהם קיים מחסור.",
          criteriaSignals: { financial_awareness: 2 },
        },
        {
      ...
      options: [
        {
          ...
          deltas: { margin: -3, customer_satisfaction: 2 },
        ...
        },
        {
          ...
          deltas: { inventory_balance: 2, customer_satisfaction: -1 },
        ...
        },
        {
          ...
          deltas: { customer_satisfaction: -2 },
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          deltas: { margin: -2, inventory_balance: 3 },
